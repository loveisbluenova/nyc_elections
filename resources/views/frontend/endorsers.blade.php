                                                    ...
                                                    <div class="col-md-4" style="padding-left: 0;">
                                                        ...
                                                        <form class="search-form" action="page_general_search.html" method="GET">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-btn" style="border-bottom: 1px solid #c2cad8; border-top: 1px solid #c2cad8; border-right: 1px solid #c2cad8;border-bottom-right-radius: 4px; border-top-right-radius: 4px;background-color: #fafafa;">
